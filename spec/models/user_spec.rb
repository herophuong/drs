...
describe User do
    ...
    describe "should be active after activate" do
    ...
    describe "with manager attribute set to 'true'" do
        before { user.toggle!(:manager) }
        
        it { should be_manager }
    end
    
    describe "accessible attributes" do
        it "should not allow access to manager attr" do
            expect do
                User.new(manager: true)
            end.should raise_error(ActiveModel::MassAssignmentSecurity::Error)
        end
        
        it "should not allow access to state attr" do
            expect do
                User.new(state: '1')
            end.should raise_error(ActiveModel::MassAssignmentSecurity::Error)
        end
    ...
    describe "when email format is valid" do
        it "should be valid" do
            addresses =  %w[user@framgia.com A_US-ER@fRAmgia.com frst.lst@fRamGia.com a+b@framgia.com]
    ...
    describe "email address with mixed case" do
        let(:mixed_case_email) { "Foo@FrAMgia.com" }
